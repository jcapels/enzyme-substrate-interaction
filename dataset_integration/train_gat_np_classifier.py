...
def experiment_optimize(ids_for_datasets):
    ...
    experiment = BindingExperiment(ids_for_datasets=ids_for_datasets, study_name="binding_3d_gat_np_classifier", storage="sqlite:///binding_3d_gat_np_classifier.db", sampler= optuna.samplers.TPESampler(seed=123),
