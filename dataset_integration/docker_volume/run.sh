...
graphpart needle --fasta-file unique_enzymes_augmented.fasta --threshold 0.8 --out-file graphpart_assignments_0_8_train_test_split_augmented.csv --test-ratio 0.2 --val-ratio 0.1 --threads 50

# python3 alignment_script.py 
