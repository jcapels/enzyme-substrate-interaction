...
def generate_features_for_compounds(multi_input_dataset):
    ...
    featurizer = DeepMolDescriptors(preset="np_classifier_fp", n_jobs=10, kwargs={"useChirality": True})
    featurizer.fit_transform(multi_input_dataset, "ligands")
    multi_input_dataset.save_features("features_compounds_np_classifier_fp_chirality")
