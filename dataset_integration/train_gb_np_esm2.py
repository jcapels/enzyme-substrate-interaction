...
def evaluate_model(model_name, save_pred_path, train_dataset, validation_dataset, test_dataset, similarity, proteins=True, suffix_results =""):
    ...
    if test_dataset.X["proteins"].shape[0] != 0:
        ...
        for seed in range(5):
            ...
            results = {
                ...
                'mcc': mcc,
                'seed':seed,
                'num_samples_test': len(test_dataset.y),
                similarity_name: similarity,
            }
...
def experiment_features(model_name, dataset = "curated_dataset_no_stereochemistry_duplicates.csv",enzymes_features="esm2_3b_ec_number_embedding", compounds_features="features_compounds_np_classifier_fp"):
...
def experiment_np_esm2_augmented(enzymes_features="features_proteins_esm2_3b_ec_number_augmented_embedding", compounds_features="features_compounds_np_classifier_fp_augmented"):
    experiment_features(enzymes_features=enzymes_features, dataset="augmented_dataset_with_rhea_negatives.csv", compounds_features=compounds_features, model_name="xgb_np_esm2_augmented")
...
def experiment_np_esm2_np_chirality(enzymes_features="esm2_3b_ec_number_embedding", compounds_features="features_compounds_np_classifier_fp_chirality"):
    experiment_features(enzymes_features=enzymes_features, compounds_features=compounds_features, model_name="xgb_np_esm2_chirality")

def experiment_prot_bert_np_chirality(enzymes_features="prot_bert_ec_number_embedding", compounds_features="features_compounds_np_classifier_fp_chirality"):
    experiment_features(enzymes_features=enzymes_features, compounds_features=compounds_features, model_name="xgb_np_prot_bert_chirality")

def experiment_esm1b_np_chirality(enzymes_features="esm1b_ec_number_embedding", compounds_features="features_compounds_np_classifier_fp_chirality"):
    experiment_features(enzymes_features=enzymes_features, compounds_features=compounds_features, model_name="xgb_np_esm1b_chirality")
...
def train_model_and_evaluate_for_classes(split_path, general_split, model_name, 
    ...
    train_dataset, validation_dataset, test_datasets = load_datasets_compound_classes(general_split, split)
...
if __name__ == "__main__":
    ...
    # train_protbert_and_evaluate_for_classes()
    # train_esm1b_and_evaluate_for_classes()
    train_esm2_3b_and_evaluate_for_classes()
