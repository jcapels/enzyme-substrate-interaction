...
def load_datasets(enzymes_features="prot_bert_ec_number_embedding", compounds_features="features_compounds_np_classifier_fp"):
    ...
    train_dataset = MultiInputDataset(train_dataset, representation_field={"proteins": "Protein sequence",
                                                                                                        "ligands": "SMILES"},
    ...
    validation_dataset = MultiInputDataset(validation_dataset, representation_field={"proteins": "Protein sequence", "ligands": "SMILES",
                                                                                            },
                                                                                            instances_ids_field={"proteins": "Uniprot ID",
                                                                                                                "ligands": "molecule ID", 
                                                                                            },
    ...
    test_dataset = MultiInputDataset(test_dataset, representation_field={"proteins": "Protein sequence",
                                                                                                        "ligands": "SMILES", 
                                                                                            },
                                                                                            instances_ids_field={"proteins": "Uniprot ID",
                                                                                                                "ligands": "molecule ID", 
