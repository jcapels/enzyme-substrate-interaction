...
class InteractionModelTransferLearning(nn.Module):
    ...
    def __init__(self, protein_head_layers, compound_head_layers, final_head_layers, batch_norm, dropout) -> None:
        ...
        self.interaction_model = DNN(input_dim, final_head_layers, 1, batch_norm=batch_norm, last_sigmoid=True, dropout=dropout)
...
class InteractionModel(L.LightningModule):
    ...
    def __init__(self, protein_head_layers, compound_head_layers,
                       ...
                       batch_norm=True, dropout=0.1) -> None:
